...
UPDATE directories_graph.directories_content SET graph_name ='nourrisseurs' WHERE graph_name ISNULL;
UPDATE directories_graph.geocoding SET graph_name ='nourrisseurs' WHERE graph_name ISNULL;
INSERT INTO directories_graph.dataset VALUES ('Nourrisseurs', '2023-10-06', 'nourrisseurs');